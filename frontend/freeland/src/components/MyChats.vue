...
.chat-layout { display: grid; grid-template-columns: 320px 1fr; gap: 16px; min-height: 70vh; }
.chat-list, .chat-content { padding: 16px; }
...
.messages { min-height: 420px; max-height: 52vh; overflow-y: auto; padding-right: 8px; }

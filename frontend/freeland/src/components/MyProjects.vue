    ...
    >
      <div class="modal-container ios-glass">
        <div class="modal-header">
          <h2 class="modal-title">Редактировать проект</h2>
        ...
        <form class="modal-form" @submit.prevent="saveProjectEdit">
          <div class="form-group">
            ...
            <input v-model="editingProject.title" type="text" class="form-input" required />
          </div>

          <div class="form-group">
            <label>Описание</label>
            <textarea v-model="editingProject.description" class="form-input" rows="4" />
          </div>

          <div class="form-row">
            <div class="form-group">
              <label>Бюджет</label>
              <input v-model.number="editingProject.budget" type="number" min="0" class="form-input" />
            </div>
            <div class="form-group">
              <label>Дедлайн</label>
              <input v-model="editingProject.deadline" type="date" class="form-input" :min="today" />
            </div>
          </div>

          <div class="form-group">
            <label>Категория</label>
            <select v-model="editingProject.category_id" class="form-input">
          ...
          <div class="modal-actions">
            <button type="button" class="modal-button cancel" @click="closeEditModal">
              Отмена
            </button>
